        ...
        courses: [
            {
                ...
                subCourses: [
                    {
                        subtitle: "Introduce Camp & Digital Insight",
                        duration: "16H",
                        details: [
                            "Introduce Camp & Digital Insight",
            ...
            },
            {
                ...
                subCourses: [
                    {
                        subtitle: "풀 스택 (Full-Stack) AI 서비스 개발",
                        duration: "328H",
                        details: [
                            "특강 (Digital Insight 2) - 서비스 개발을 위한 DevOps Tools",
        ...
        courses: [
            {
                ...
                subCourses: [
                    {
                        subtitle: "AM (Application Modernization) 기술: MSA, Cloud, Agile",
                        duration: "192H",
                        details: [
                            "AM (Application Modernization) 기반의 MSA 기술 I & II",
                            "미니 PJT 2 (AWS, NCP, Docker, Kubernetes, CI/CD, Prometheus, Grafana)",
                    ...
                    {
                        subtitle: "특강 (Digital Insight 3) 오프라인 시작 / 25.06.30",
                        duration: "16H",
                        details: ["LG CNS 현직 전문가와 함께하는 AM Agile 특강"],
                    },
                ],
            },
            {
